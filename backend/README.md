...
## Project Structure
    ...
    ├── testapiautosetting_125096  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125096`
...
2. Clone this repo and `cd testapiautosetting_125096`
